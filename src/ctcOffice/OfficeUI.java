...
public class OfficeUI extends JFrame {
	...
	public OfficeUI() {
		...
		//For simulation only
		toggleButtonG2.block = 2;
		toggleButtonG2.length = 100;
		toggleButtonG2.grade = 1;
		toggleButtonG2.speed = 55;
		toggleButtonG2.elevation = 1;
		toggleButtonG2.status = 1;
		toggleButtonG2.train = -1;
